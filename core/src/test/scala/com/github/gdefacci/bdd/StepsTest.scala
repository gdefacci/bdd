...
class StepsTest extends FunSuite {
  ...
  test("Step description 1") {
    val src = Flow[String, Id](Text("a"), () => "aa") And Step[String, Id](Text("b"), a => "bb" + a)

    assert(src.description.mkString("-") == "a-and b")

    val src1 = Flow[String, Id](Text("a"), () => "aa") But Step[String, Id](Text("b"), a => "bb" + a)
  ...
  test("Step description 2") {
    val src = Flow[String, Id](Text("a"), () => "aa") And Step[String, Id](Text("b"), a => "bb" + a) Then Step[String, Id](Text("c"), a => "bb" + a) And
  ...
  test("Step description 3") {
    val src = Flow[String, Id](Text("a"), () => "aa") And
